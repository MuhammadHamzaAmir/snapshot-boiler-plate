    ...
    return (
      <div>
        ...
        >
          ...
          />
          <div className="w-64 z-20 absolute left-0 z-40 top-0 bg-gray-800 shadow flex-col justify-between transition duration-150 ease-in-out h-full">
                    ...
                    <li className="text-white pt-8">
                      <div className="flex items-center">
                        <div className="flex items-center">
                          ...
                          <p className="text-white ml-3 text-lg">Products</p>
                        </div>
                      ...
                      {product ? (
                        <div>
                          <ul className="my-3">
                            ...
                            <li className="text-sm text-white hover:text-indigo-500 py-2 px-6">
                              Out of Stock
                            </li>
                            <li className="text-sm text-white hover:text-indigo-500 py-2 px-6">
                              New Products
                  ...
                  <a>
                    <li className="text-white pt-8">
                      <div className="flex items-center">
                        ...
                        <p className="text-white ml-3 text-lg">Performance</p>
                      </div>
                    </li>
                  </a>
                  <a>
                      ...
                      <li className="text-white pt-8">
                        <div className="flex items-center">
                          <div className="flex items-center">
                            ...
                            <p className="text-white ml-3 text-lg">
                              Deliverables
                            </p>
                          </div>
        ...
        <nav className="w-full mx-auto bg-gray-800 border-b border-gray-700 shadow relative z-20">
          <div className="container px-6 h-16 flex items-center justify-between mx-auto">
            <div className="flex items-center">
              <div className="rounded-full relative p-3 flex justify-end text-gray-500">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="icon icon-tabler icon-tabler-search"
                  width={20}
            ...
            <ul className="flex items-center justify-center h-full">
              <li className="cursor-pointer h-full xl:flex items-center text-sm text-indigo-500 tracking-normal hidden">
                Dashboard
              </li>
              <li className="cursor-pointer h-full xl:flex items-center text-sm text-white ml-0 xl:ml-10 tracking-normal hidden">
                Products
              </li>
              ...
              <li className="cursor-pointer h-full xl:flex items-center text-sm text-white mr-10 tracking-normal hidden">
                Performance
              </li>
              <li className="cursor-pointer h-full xl:flex items-center text-sm text-white tracking-normal hidden">
                Deliverables
              </li>
            </ul>
            <div
              aria-haspopup="true"
              className="cursor-pointer h-full xl:flex items-center justify-end hidden relative"
            >
        ...
        <div className="relative z-10 bg-gray-800 pt-8 pb-16">
          <div className="container px-6 mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between">
            ...
            <div className="mt-6 lg:mt-0">
              <button className="focus:outline-none mr-3 bg-transparent transition duration-150 ease-in-out hover:bg-gray-700 rounded text-white px-5 py-2 text-sm border border-white">
                Back
              </button>
